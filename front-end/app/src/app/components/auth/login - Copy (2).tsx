...
export const Login = () => {
  ...
  return (
	...
	<div class="flex flex-col gap-2 p-4 text-sm bg-lightsuccess dark:bg-lightsuccess text-success border-success rounded-md" role="alert"><div class="flex items-center" data-testid="flowbite-alert-wrapper"><div><span class="font-medium">Success</span> A simple Success alert</div></div></div>
